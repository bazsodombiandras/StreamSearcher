...
namespace Logging
{
	...
	private:
		/// <summary>
		/// The maximum log level. Any message which has a level higher than this will be omitted.
		/// </summary>
		MsgType logLevel;

		/// <summary>
		/// Specifies whether a time stamp should be included into the log messages.
		/// </summary>
